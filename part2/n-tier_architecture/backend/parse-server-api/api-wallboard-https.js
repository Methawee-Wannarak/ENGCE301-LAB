...
const config = {
  databaseURI: 'mongodb://wallboarduser:WB1qazxsw2@192.168.3.5:27017/wallboarddb',
  ...
  serverURL: 'https://172.19.71.62:' + apiport + '/api', // Don't forget to change to https if needed
  publicServerURL: 'https://172.19.71.62:' + apiport + '/api',
  liveQuery: {
